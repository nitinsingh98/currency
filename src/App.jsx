        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            <div className="w-full mb-1">
              <InputBox label="From" amount={amount} onCurrencyChange={(from) => setFrom(from)} onAmountChange={(amount) => setAmount(amount)} currencyOption={currencyList} selectCurrency={from} />
            </div>
            ...
            <div className="w-full mt-1 mb-4">
              <InputBox label="To" amount={convertedAmount} onCurrencyChange={(to) => setTo(to)} currencyOption={currencyList} selectCurrency={to} amountDisable={true} />
